...
-- retrieve historical batches of FDY
select batch_id,
       sum(weight) as total_weight,  -- input
       sum(weight * o.price - o.voucher) as total_price, -- output
       s.total_weight_inhist, -- input: whether the specification is common
...
from orders_historical o join customers c on c.name = o.customer_name and c.production = o.production
